...
setlocal winbar=%#SagaFolder#ï¼\ %*%#SagaFolderName#nvim%*%#SagaSep#\ â€º\ %*%#DevIconLua#î˜ \ %*%#SagaFileName#init.lua%#SagaSep#\ â€º\ %*%#SagaObject#î­›\ sign%#SagaSep#\ â€º\ %*%#SagaString#ó°…³\ name
setlocal winblend=0
